    ...
    <div class="col-sm-6">
        <form method="POST" enctype="multipart/form-data" id="fileUploadForm" action="/upload">
            ...
            <div class="text-right">
                <button type="submit" onclick="" class="form-button btn btn-default" id="btnSubmit">Upload</button>
            </div>
        </form>
    </div>
</div>
<div>
    ...
    <form>
        ...
        <input type="button" onclick="document.location.reload(true)" value="Load Files" name="loadData"/>
        <br/><br/>
